...
import { registerGetCustomerIdTool } from './definitions/get_customer_id'
import { registerListOrgUnitsTool } from './definitions/list_org_units'
import { registerCheckCepSubscriptionTool } from './definitions/check_cep_subscription'
import { registerCheckUserCepLicenseTool } from './definitions/check_user_cep_license'
import { registerCountBrowserVersionsTool } from './definitions/count_browser_versions'
import { registerCustomerProfileTool } from './definitions/list_customer_profiles'
import { registerGetConnectorPolicyTool } from './definitions/get_connector_policy'
import { registerGetChromeActivityLogTool } from './definitions/get_chrome_activity_log'
import { registerListDlpRulesTool } from './definitions/list_dlp_rules'
import { registerGetDlpRuleTool } from './definitions/get_dlp_rule'
import { registerListDetectorsTool } from './definitions/list_detectors'
import { registerCreateChromeDlpRuleTool } from './definitions/create_chrome_dlp_rule'
import { registerDeleteAgentDlpRuleTool } from './definitions/delete_agent_dlp_rule'
import { registerDeleteDetectorTool } from './definitions/delete_detector'
import { registerCreateRegexDetectorTool } from './definitions/create_regex_detector'
import { registerCreateUrlListDetectorTool } from './definitions/create_url_list_detector'
import { registerCreateWordListDetectorTool } from './definitions/create_word_list_detector'
import { registerCreateDefaultDlpRulesTool } from './definitions/create_default_dlp_rules'
import { registerCheckSebExtensionStatusTool } from './definitions/check_seb_extension_status'
import { registerInstallSebExtensionTool } from './definitions/install_seb_extension'
import { registerCheckAndEnableCepApiTool } from './definitions/check_and_enable_cep_api'
import { registerEnableChromeEnterpriseConnectorsTool } from './definitions/enable_chrome_enterprise_connectors'
import { registerDiagnoseEnvironmentTool } from './definitions/diagnose_environment'
import { registerKnowledgeTools } from './definitions/knowledge'
