...
class TestListDlpRules(McpIntegrationTestBase):

  def test_list_dlp_rules(self):
    """Verify agent can list DLP rules and finds a specific rule."""
    prompt = "Show me my DLP rules for customer ID C0123456. Include names of blocked domains in output if possible."
