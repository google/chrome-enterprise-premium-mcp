...
describe('Server Instructions', () => {
  ...
  test('When server instructions are built, then they include the agent capabilities contract', () => {
    const out = buildServerInstructions()
    assert.match(out, /AI Agent Capabilities and Limitations/)
  })

  test('When server instructions are built, then they do NOT inline the Knowledge Index', () => {
    const out = buildServerInstructions()
