...
export class CloudIdentityClient {
   ...
   * @param {import('../util/credential/index.js').Credential} [_credential] - Credential for API authentication.
   * @returns {Promise<Array<object>>} - A list of policies.
   * @throws {Error} - If the API call fails.
   */
  async listDlpRules(_credential) {
   ...
   * @throws {Error} - If the API call fails.
   */
  async listDetectors(_credential) {
    throw new Error('Not implemented')
  }
   ...
   */
  async createDlpRule(_customerId, _orgUnitId, _ruleConfig, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async deleteDlpRule(_policyName, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async createDetector(_customerId, _orgUnitId, _detectorConfig, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async deleteDetector(_policyName, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async getDlpRule(_policyName, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async getDetector(_policyName, _credential) {
    throw new Error('Not implemented')
  }
}
