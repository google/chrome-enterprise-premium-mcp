...
export class ChromePolicyClient {
   ...
   * @returns {Promise<Array<object>>} - An array of connector policies.
   * @throws {Error} - If the API call fails.
   */
  async getConnectorPolicy(_customerId, _orgUnitId, _policySchemaFilter, _credential) {
   ...
   */
  async resolvePolicy(_customerId, _orgUnitId, _policySchemaFilter, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @param {import('../util/credential/index.js').Credential} [_credential] - Credential for API authentication.
   * @returns {Promise<object>} - The result of the batch modification.
   */
  async batchModifyPolicy(_customerId, _orgUnitId, _requests, _credential) {
    throw new Error('Not implemented')
  }
}
