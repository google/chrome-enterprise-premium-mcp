...
/**
 * @file Interface for Google API enablement client wrappers.
 */
...
export class ServiceUsageClient {
   ...
   * @returns {Promise<Set<string>>} - Set of enabled service names (e.g. 'admin.googleapis.com').
   * @throws {Error} - If the API call fails.
   */
  async listEnabledServices(_projectId, _authToken) {
