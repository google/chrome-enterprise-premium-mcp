...
export class AdminSdkClient {
   ...
   */
  async getCustomerId(_credential) {
   ...
   * @throws {Error} - If the API call fails.
   */
  async listOrgUnits(_options, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async listChromeActivities(_options, _credential) {
    throw new Error('Not implemented')
  }
   ...
   * @throws {Error} - If the API call fails.
   */
  async checkCepSubscription(_customerId, _credential) {
    throw new Error('Not implemented')
  }
   ...
   */
  async checkUserCepLicense(_userId, _credential) {
    throw new Error('Not implemented')
  }
}
