...
export async function listChromeActivities(options, authToken) {
    const authClient = await getAuthClient([SCOPES.ADMIN_REPORTS_AUDIT_READONLY], authToken)
...
export async function listOrgUnits(options, authToken) {
    const authClient = await getAuthClient([SCOPES.ADMIN_DIRECTORY_ORGUNIT_READONLY], authToken)
...
export async function getCustomerId(authToken) {
    const authClient = await getAuthClient([SCOPES.ADMIN_DIRECTORY_CUSTOMER_READONLY], authToken)
