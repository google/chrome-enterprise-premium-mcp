...
export class RealServiceUsageClient extends ServiceUsageClient {
   ...
   * @returns {Promise<object>} A promise that resolves to the Service Usage API client.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<object>} A promise that resolves to the service status data.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<object>} A promise that resolves to the API response data (LRO).
   */
