...
async function deletePolicyWithValidation(policyName, validationFn, typeDisplay, authToken, apiOptions) {
  ...
  try {
    ...
    console.error(`${TAGS.API} ✗ Error deleting ${typeDisplay}:`, error)
    throw error
  }
}
