 ...
 */
async function getPolicyClient(credential, apiOptions) {
 ...
 */
export async function listDlpRules(credential, apiOptions = {}) {
  return listDlpPolicies(POLICY_TYPES.RULE, credential, apiOptions)
}
 ...
 * @throws {Error} If the API call fails
 */
export async function listDetectors(credential, apiOptions = {}) {
  return listDlpPolicies(POLICY_TYPES.DETECTOR, credential, apiOptions)
}
 ...
 * @throws {Error} If the API call fails
 */
export async function listDlpPolicies(type, credential, apiOptions = {}) {
  const client = await getPolicyClient(credential, apiOptions)
  try {
 ...
 * @throws {Error} If the API call fails
 */
export async function createDlpRule(customerId, orgUnitId, ruleConfig, credential, apiOptions = {}) {
  const client = await getPolicyClient(credential, apiOptions)
  try {
    const request = {
      requestBody: {
 ...
 */
export async function deleteDlpRule(policyName, credential, apiOptions = {}) {
 ...
 * @param {import('../util/credential/index.js').Credential} [credential] - Credential for API authentication
 * @param {object} [apiOptions] - Options for API client creation
 * @returns {Promise<object>} The created detector object
 * @throws {Error} If the API call fails
 */
export async function createDetector(customerId, orgUnitId, detectorConfig, credential, apiOptions = {}) {
  const client = await getPolicyClient(credential, apiOptions)
  try {
 ...
 * @throws {Error} If validation fails or deletion fails
 */
export async function deleteDetector(policyName, credential, apiOptions = {}) {
  return deletePolicyWithValidation(
    policyName,
 ...
 * @throws {Error} If validation fails or deletion fails
 */
async function deletePolicyWithValidation(policyName, validationFn, typeDisplay, credential, apiOptions) {
  const client = await getPolicyClient(credential, apiOptions)
  try {
