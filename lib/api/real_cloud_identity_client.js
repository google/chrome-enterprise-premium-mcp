...
export class RealCloudIdentityClient extends CloudIdentityClient {
   ...
   * @returns {Promise<object>} A promise that resolves to the Cloud Identity Policies API client.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<Array<object>>} A promise that resolves to an array of DLP rules.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<Array<object>>} A promise that resolves to an array of detectors.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<object>} A promise that resolves to the created policy data.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<object>} A promise that resolves to the policy data.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<object>} A promise that resolves to the detector data.
   */
   ...
   * @param {string} [authToken] Optional authentication token.
   * @returns {Promise<object>} A promise that resolves to the created detector data.
