...
async function getChromePolicyClient() {
 ...
 * @returns {Promise<Array<object>>} - A promise that resolves to an array of policies.
 */
export async function getConnectorPolicy(customerId, orgUnitId, policySchemaFilter, progressCallback) {
  const client = await getChromePolicyClient();
  try {
