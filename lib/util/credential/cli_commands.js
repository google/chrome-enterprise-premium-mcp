...
/**
 * Writes the custom-client notice marker. Called after a successful runLoginFlow so a
 ...
 * @param {string} [opts.noticePath] Path to the custom-client notice marker file for testing.
