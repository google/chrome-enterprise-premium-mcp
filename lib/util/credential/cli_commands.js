...
/**
 * Probes the OAuth-flow credential cache and prints a one-line status report.
 * Exits 0 in all cases; a non-OK probe is informational.
...
export async function runAuthStatusCommand() {
  ...
  console.log('  OAuth: ' + buildScopesField(oauthProbe, scopes))
}
