...
export const CEL_SYNTAX_GUIDE = [
  {
    ...
    examples: ["all_content.contains('secret')"],
  },
  {
...
export const CEL_FUNCTIONS = {
  ...
  // Detectors
  "matches_dlp_detector('name')": 'Matches a predefined DLP detector.',
  "matches_regex_detector('name')": 'Matches a custom regex detector.',
  "matches_word_list('name')": 'Matches a custom word list detector.',
  "matches_url_list('name')": 'Matches a custom URL list detector.',
...
export const ACTION_PARAMETER_CONSTRAINTS = {
  customMessage: "Not supported with the 'AUDIT' action type.",
  watermarkMessage: "Only supported with 'WARN' and 'AUDIT' actions; ignored for 'BLOCK'.",
  blockScreenshot: "Only supported with 'WARN' and 'AUDIT' actions; ignored for 'BLOCK'.",
}
