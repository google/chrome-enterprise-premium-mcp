 ...
 * This is used to populate the '11-dlp-cel-syntax' knowledge document dynamically.
...
export function generateDlpCelReference() {
  ...
  return `# Chrome DLP CEL Condition Reference

This document provides a comprehensive technical reference for writing Common Expression Language (CEL) conditions and configuring actions for Chrome Data Loss Prevention (DLP) rules.
...
## 8. Action and Safety Constraints
