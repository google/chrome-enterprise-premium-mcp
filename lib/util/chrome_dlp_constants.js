...
/**
 * Shared metadata for Chrome DLP rules, used for both tool descriptions and validation.
 * Organized by Rule Configuration, CEL Grammar, CEL Vocabulary, and Logic Constraints.
 */

// =============================================================================
// I. RULE CONFIGURATION (Triggers, Actions, Masks)
// =============================================================================
...
// =============================================================================
// II. CEL GRAMMAR (Content Types and Functions)
// =============================================================================
...
export const CEL_FUNCTIONS = {
  ...
  "matches_dlp_detector('RESOURCE_NAME', {params})": 'Matches a predefined DLP detector.',
  ...
  'Note for Detectors':
    "'RESOURCE_NAME' must be the full name field (e.g., 'policies/abc-123') returned by list_detectors or detector creation tools.",

  // Enums and Categories
  "matches_web_category('CATEGORY')": "Matches a web category (only on 'url_category' or 'source_url_category').",
  "matches_enum('VALUE')":
    "Matches an enum value (e.g. risk levels on 'url_category', or context on 'source_chrome_context').",
...
// =============================================================================
// III. CEL VOCABULARY (Reference Values and Enums)
// =============================================================================

/**
 * Metadata for enum-like fields used inside CEL conditions.
 */
export const URL_RISK_LEVELS = {
  LOW: { value: 'LOW', description: 'Low risk' },
  MEDIUM: { value: 'MEDIUM', description: 'Medium risk' },
  HIGH: { value: 'HIGH', description: 'High risk' },
}
...
// =============================================================================
// IV. LOGIC CONSTRAINTS (CEL and Action Parameters)
// =============================================================================
...
export const CEL_COMPATIBILITY_RULES = {
  ...
  'Risk Level':
    "Risk level filtering is supported via 'url.matches_enum' for URL_NAVIGATION, or 'url_category.matches_enum' for FILE_DOWNLOAD. Direct use of 'url_risk_level' is not supported in CEL.",
...
export const ADMIN_CONSOLE_DLP_RULE_LINK_TEMPLATE = 'https://admin.google.com/ac/dp/rules/{URL_ENCODED_RESOURCE_NAME}?dlpRulesList=true'
...
export const MCP_SAFETY_CONSTRAINTS = {
  ACTIVE_BLOCK_RESTRICTION: "For safety reasons, this MCP tool is disabled from creating 'ACTIVE' rules with a 'BLOCK' action. You can create 'INACTIVE' 'BLOCK' rules and enable them later in the UI, or create 'ACTIVE' 'WARN' or 'AUDIT' rules.",
}
