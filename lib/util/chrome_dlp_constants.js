...
export const ACTION_PARAMETER_CONSTRAINTS = {
  ...
  DATA_MASKING_SUPPORT:
    "The 'dataMasking' parameter is only supported with the 'URL_NAVIGATION' trigger and 'WARN' or 'AUDIT' actions. Currently, only custom regular expressions and predefined detectors are supported for data masking (word lists and URL lists are not supported).",
}
