 ...
 * @returns {string} System prompt + capabilities contract + knowledge index.
 */
export function buildServerInstructions() {
  if (cachedPayload === null) {
    cachedPayload = [fs.readFileSync(SYSTEM_PROMPT_PATH, 'utf8'), fs.readFileSync(CAPABILITIES_PATH, 'utf8')].join(
      '\n\n---\n\n',
    )
  }
