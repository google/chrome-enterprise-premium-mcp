...
//
// Derived from SCOPES (minus CLOUD_PLATFORM) so a new entry added to SCOPES
// flows into SCOPES_OAUTH automatically.
const { CLOUD_PLATFORM: _omitted, ...SCOPES_WITHOUT_CLOUD_PLATFORM } = SCOPES
export const SCOPES_OAUTH = {
  ...SCOPES_WITHOUT_CLOUD_PLATFORM,
