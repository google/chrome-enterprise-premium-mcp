...
// SCOPES is the canonical scope set for ADC and gcloud. CLOUD_PLATFORM is broad
// (every enabled Cloud API) but acceptable here because the user already holds it.
export const SCOPES = {
...
// SCOPES_OAUTH is the scope set for OAuth consent screens. CLOUD_PLATFORM is
// replaced by service.management (write) and service.management.readonly (read)
// so the consent screen doesn't grant "Manage everything in Google Cloud" for a
// server that only calls Service Usage. See issue #113.
export const SCOPES_OAUTH = {
  EMAIL: SCOPES.EMAIL,
  CHROME_MANAGEMENT_POLICY: SCOPES.CHROME_MANAGEMENT_POLICY,
  CHROME_MANAGEMENT_REPORTS_READONLY: SCOPES.CHROME_MANAGEMENT_REPORTS_READONLY,
  CHROME_MANAGEMENT_PROFILES_READONLY: SCOPES.CHROME_MANAGEMENT_PROFILES_READONLY,
  ADMIN_REPORTS_AUDIT_READONLY: SCOPES.ADMIN_REPORTS_AUDIT_READONLY,
  ADMIN_DIRECTORY_ORGUNIT_READONLY: SCOPES.ADMIN_DIRECTORY_ORGUNIT_READONLY,
  ADMIN_DIRECTORY_CUSTOMER_READONLY: SCOPES.ADMIN_DIRECTORY_CUSTOMER_READONLY,
  LICENSING: SCOPES.LICENSING,
  CLOUD_IDENTITY_POLICIES: SCOPES.CLOUD_IDENTITY_POLICIES,
