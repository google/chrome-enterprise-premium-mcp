...
export const OAUTH_SCOPE_CONFIG = Object.freeze({
  ...
  CHROME_MANAGEMENT_SECURITYINSIGHTS_READONLY: {
    url: 'https://www.googleapis.com/auth/chrome.management.securityinsights.readonly',
    name: 'Chrome Security Insights Readonly',
    category: 'Chrome browser management',
  },
